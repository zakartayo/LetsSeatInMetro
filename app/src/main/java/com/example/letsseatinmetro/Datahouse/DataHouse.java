...
public class DataHouse {
    ...
    public static List<LineCardItem> line2 = new ArrayList<LineCardItem>() {
        {
            add(new LineCardItem(R.drawable.line_img_1, "시청"));
            add(new LineCardItem(R.drawable.line_img_1, "충정로"));
            add(new LineCardItem(R.drawable.line_img_1, "아현"));
            add(new LineCardItem(R.drawable.line_img_1, "이대"));
            add(new LineCardItem(R.drawable.line_img_1, "신촌"));
            add(new LineCardItem(R.drawable.line_img_1, "홍대입구"));
            add(new LineCardItem(R.drawable.line_img_1, "합정"));
            add(new LineCardItem(R.drawable.line_img_1, "당산"));
            add(new LineCardItem(R.drawable.line_img_1, "영등포구청"));
            add(new LineCardItem(R.drawable.line_img_1, "문래"));
            add(new LineCardItem(R.drawable.line_img_1, "신도림"));
            add(new LineCardItem(R.drawable.line_img_1, "도림천"));
            add(new LineCardItem(R.drawable.line_img_1, "양천구청"));
            add(new LineCardItem(R.drawable.line_img_1, "신정네거리"));
            add(new LineCardItem(R.drawable.line_img_1, "까치산"));
            add(new LineCardItem(R.drawable.line_img_1, "대림"));
            add(new LineCardItem(R.drawable.line_img_1, "구로디지털단지"));
            add(new LineCardItem(R.drawable.line_img_1, "신대방"));
            add(new LineCardItem(R.drawable.line_img_1, "신림"));
            add(new LineCardItem(R.drawable.line_img_1, "봉천"));
            add(new LineCardItem(R.drawable.line_img_1, "서울대입구"));
            add(new LineCardItem(R.drawable.line_img_1, "낙성대"));
            add(new LineCardItem(R.drawable.line_img_1, "사당"));
            add(new LineCardItem(R.drawable.line_img_1, "방배"));
            add(new LineCardItem(R.drawable.line_img_1, "서초"));
            add(new LineCardItem(R.drawable.line_img_1, "교대"));
            add(new LineCardItem(R.drawable.line_img_1, "강남"));
            add(new LineCardItem(R.drawable.line_img_1, "역삼"));
            add(new LineCardItem(R.drawable.line_img_1, "선릉"));
            add(new LineCardItem(R.drawable.line_img_1, "삼성"));
            add(new LineCardItem(R.drawable.line_img_1, "종합운동장"));
            add(new LineCardItem(R.drawable.line_img_1, "잠실새내"));
            add(new LineCardItem(R.drawable.line_img_1, "잠실"));
            add(new LineCardItem(R.drawable.line_img_1, "잠실나루"));
            add(new LineCardItem(R.drawable.line_img_1, "강변"));
            add(new LineCardItem(R.drawable.line_img_1, "구의"));
            add(new LineCardItem(R.drawable.line_img_1, "건대입구"));
            add(new LineCardItem(R.drawable.line_img_1, "성수"));
            add(new LineCardItem(R.drawable.line_img_1, "용답"));
            add(new LineCardItem(R.drawable.line_img_1, "신답"));
            add(new LineCardItem(R.drawable.line_img_1, "용두"));
            add(new LineCardItem(R.drawable.line_img_1, "신설동"));
            add(new LineCardItem(R.drawable.line_img_1, "뚝섬"));
            add(new LineCardItem(R.drawable.line_img_1, "한양대"));
            add(new LineCardItem(R.drawable.line_img_1, "왕십리"));
            add(new LineCardItem(R.drawable.line_img_1, "상왕십리"));
            add(new LineCardItem(R.drawable.line_img_1, "신당"));
            add(new LineCardItem(R.drawable.line_img_1, "동대문역사문화공원"));
            add(new LineCardItem(R.drawable.line_img_1, "을지로4가"));
            add(new LineCardItem(R.drawable.line_img_1, "을지로3가"));
            add(new LineCardItem(R.drawable.line_img_1, "을지로입구"));
            add(new LineCardItem(R.drawable.line_img_1, "시청"));
        }
    };
    ...
    public static List<LineCardItem> line3 = new ArrayList<LineCardItem>() {
        {
            add(new LineCardItem(R.drawable.line_img_1, "대화"));
            add(new LineCardItem(R.drawable.line_img_1, "주엽"));
            add(new LineCardItem(R.drawable.line_img_1, "정발산"));
            add(new LineCardItem(R.drawable.line_img_1, "마두"));
            add(new LineCardItem(R.drawable.line_img_1, "백석"));
            add(new LineCardItem(R.drawable.line_img_1, "대곡"));
            add(new LineCardItem(R.drawable.line_img_1, "화정"));
            add(new LineCardItem(R.drawable.line_img_1, "원당"));
            add(new LineCardItem(R.drawable.line_img_1, "원홍"));
            add(new LineCardItem(R.drawable.line_img_1, "삼송"));
            add(new LineCardItem(R.drawable.line_img_1, "지축"));
            add(new LineCardItem(R.drawable.line_img_1, "구파발"));
            add(new LineCardItem(R.drawable.line_img_1, "연신내"));
            add(new LineCardItem(R.drawable.line_img_1, "불광"));
            add(new LineCardItem(R.drawable.line_img_1, "녹번"));
            add(new LineCardItem(R.drawable.line_img_1, "홍제"));
            add(new LineCardItem(R.drawable.line_img_1, "무악재"));
            add(new LineCardItem(R.drawable.line_img_1, "독립문"));
            add(new LineCardItem(R.drawable.line_img_1, "경복궁"));
            add(new LineCardItem(R.drawable.line_img_1, "안국"));
            add(new LineCardItem(R.drawable.line_img_1, "종로3가"));
            add(new LineCardItem(R.drawable.line_img_1, "을지로3가"));
            add(new LineCardItem(R.drawable.line_img_1, "충무로"));
            add(new LineCardItem(R.drawable.line_img_1, "동대입구"));
            add(new LineCardItem(R.drawable.line_img_1, "약수"));
            add(new LineCardItem(R.drawable.line_img_1, "금호"));
            add(new LineCardItem(R.drawable.line_img_1, "옥수"));
            add(new LineCardItem(R.drawable.line_img_1, "압구정"));
            add(new LineCardItem(R.drawable.line_img_1, "신사"));
            add(new LineCardItem(R.drawable.line_img_1, "잠원"));
            add(new LineCardItem(R.drawable.line_img_1, "고속터미널"));
            add(new LineCardItem(R.drawable.line_img_1, "교대"));
            add(new LineCardItem(R.drawable.line_img_1, "남부터미널"));
            add(new LineCardItem(R.drawable.line_img_1, "양재"));
            add(new LineCardItem(R.drawable.line_img_1, "매봉"));
            add(new LineCardItem(R.drawable.line_img_1, "도곡"));
            add(new LineCardItem(R.drawable.line_img_1, "대치"));
            add(new LineCardItem(R.drawable.line_img_1, "학여울"));
            add(new LineCardItem(R.drawable.line_img_1, "대청"));
            add(new LineCardItem(R.drawable.line_img_1, "일원"));
            add(new LineCardItem(R.drawable.line_img_1, "수서"));
            add(new LineCardItem(R.drawable.line_img_1, "가락시장"));
            add(new LineCardItem(R.drawable.line_img_1, "경찰병원"));
            add(new LineCardItem(R.drawable.line_img_1, "오금"));
        }
    };
    ...
    public static List<LineCardItem> line4 = new ArrayList<LineCardItem>() {
        {
            ...
            add(new LineCardItem(R.drawable.line_img_1, "수리산"));
            add(new LineCardItem(R.drawable.line_img_1, "대야미"));
            add(new LineCardItem(R.drawable.line_img_1, "반월"));
            add(new LineCardItem(R.drawable.line_img_1, "상록수"));
            add(new LineCardItem(R.drawable.line_img_1, "한대앞"));
            add(new LineCardItem(R.drawable.line_img_1, "중앙"));
            add(new LineCardItem(R.drawable.line_img_1, "고잔"));
            add(new LineCardItem(R.drawable.line_img_1, "초지"));
    ...
    public static List<LineCardItem> line5 = new ArrayList<LineCardItem>() {
        {
            add(new LineCardItem(R.drawable.line_img_1, "방화"));
            add(new LineCardItem(R.drawable.line_img_1, "개화산"));
            add(new LineCardItem(R.drawable.line_img_1, "김포공항"));
            add(new LineCardItem(R.drawable.line_img_1, "송정"));
            add(new LineCardItem(R.drawable.line_img_1, "마곡"));
            add(new LineCardItem(R.drawable.line_img_1, "발산"));
            add(new LineCardItem(R.drawable.line_img_1, "우장산"));
            add(new LineCardItem(R.drawable.line_img_1, "화곡"));
            add(new LineCardItem(R.drawable.line_img_1, "까치산"));
            add(new LineCardItem(R.drawable.line_img_1, "신정"));
            add(new LineCardItem(R.drawable.line_img_1, "목동"));
            add(new LineCardItem(R.drawable.line_img_1, "오목교"));
            add(new LineCardItem(R.drawable.line_img_1, "양평"));
            add(new LineCardItem(R.drawable.line_img_1, "영등포구청"));
            add(new LineCardItem(R.drawable.line_img_1, "영등포시장"));
            add(new LineCardItem(R.drawable.line_img_1, "신길"));
            add(new LineCardItem(R.drawable.line_img_1, "여의도"));
            add(new LineCardItem(R.drawable.line_img_1, "여의나루"));
            add(new LineCardItem(R.drawable.line_img_1, "마포"));
            add(new LineCardItem(R.drawable.line_img_1, "공덕"));
            add(new LineCardItem(R.drawable.line_img_1, "애오개"));
            add(new LineCardItem(R.drawable.line_img_1, "충정로"));
            add(new LineCardItem(R.drawable.line_img_1, "서대문"));
            add(new LineCardItem(R.drawable.line_img_1, "광화문"));
            add(new LineCardItem(R.drawable.line_img_1, "종로3가"));
            add(new LineCardItem(R.drawable.line_img_1, "을지로4가"));
            add(new LineCardItem(R.drawable.line_img_1, "동대문역사문화공원"));
            add(new LineCardItem(R.drawable.line_img_1, "청구"));
            add(new LineCardItem(R.drawable.line_img_1, "신금호"));
            add(new LineCardItem(R.drawable.line_img_1, "행당"));
            add(new LineCardItem(R.drawable.line_img_1, "왕십리"));
            add(new LineCardItem(R.drawable.line_img_1, "마장"));
            add(new LineCardItem(R.drawable.line_img_1, "답십리"));
            add(new LineCardItem(R.drawable.line_img_1, "장한평"));
            add(new LineCardItem(R.drawable.line_img_1, "군자"));
            add(new LineCardItem(R.drawable.line_img_1, "아차산"));
            add(new LineCardItem(R.drawable.line_img_1, "광나루"));
            add(new LineCardItem(R.drawable.line_img_1, "천호"));
            add(new LineCardItem(R.drawable.line_img_1, "강동"));
            add(new LineCardItem(R.drawable.line_img_1, "둔촌동"));
            add(new LineCardItem(R.drawable.line_img_1, "올림픽공원"));
            add(new LineCardItem(R.drawable.line_img_1, "방이"));
            add(new LineCardItem(R.drawable.line_img_1, "오금"));
            add(new LineCardItem(R.drawable.line_img_1, "개롱"));
            add(new LineCardItem(R.drawable.line_img_1, "거여"));
            add(new LineCardItem(R.drawable.line_img_1, "마천"));
        }
    };

    public static List<LineCardItem> line6 = new ArrayList<LineCardItem>() {
        {
            add(new LineCardItem(R.drawable.line_img_1, "응암"));
            add(new LineCardItem(R.drawable.line_img_1, "역촌"));
            add(new LineCardItem(R.drawable.line_img_1, "불광"));
            add(new LineCardItem(R.drawable.line_img_1, "독바위"));
            add(new LineCardItem(R.drawable.line_img_1, "연신내"));
            add(new LineCardItem(R.drawable.line_img_1, "구산"));
            add(new LineCardItem(R.drawable.line_img_1, "응암"));
            add(new LineCardItem(R.drawable.line_img_1, "새절"));
            add(new LineCardItem(R.drawable.line_img_1, "증산"));
            add(new LineCardItem(R.drawable.line_img_1, "디지털미디어시티"));
            add(new LineCardItem(R.drawable.line_img_1, "월드컵경기장"));
            add(new LineCardItem(R.drawable.line_img_1, "마포구청"));
            add(new LineCardItem(R.drawable.line_img_1, "망원"));
            add(new LineCardItem(R.drawable.line_img_1, "합정"));
            add(new LineCardItem(R.drawable.line_img_1, "상수"));
            add(new LineCardItem(R.drawable.line_img_1, "광흥창"));
            add(new LineCardItem(R.drawable.line_img_1, "대흥"));
            add(new LineCardItem(R.drawable.line_img_1, "공덕"));
            add(new LineCardItem(R.drawable.line_img_1, "효창공원앞"));
            add(new LineCardItem(R.drawable.line_img_1, "삼각지"));
            add(new LineCardItem(R.drawable.line_img_1, "녹사평"));
            add(new LineCardItem(R.drawable.line_img_1, "이태원"));
            add(new LineCardItem(R.drawable.line_img_1, "한강진"));
            add(new LineCardItem(R.drawable.line_img_1, "버티고개"));
            add(new LineCardItem(R.drawable.line_img_1, "약수"));
            add(new LineCardItem(R.drawable.line_img_1, "청구"));
            add(new LineCardItem(R.drawable.line_img_1, "신당"));
            add(new LineCardItem(R.drawable.line_img_1, "동묘앞"));
            add(new LineCardItem(R.drawable.line_img_1, "창신"));
            add(new LineCardItem(R.drawable.line_img_1, "보문"));
            add(new LineCardItem(R.drawable.line_img_1, "안암"));
            add(new LineCardItem(R.drawable.line_img_1, "고려대"));
            add(new LineCardItem(R.drawable.line_img_1, "월곡"));
            add(new LineCardItem(R.drawable.line_img_1, "상월곡"));
            add(new LineCardItem(R.drawable.line_img_1, "돌곶이"));
            add(new LineCardItem(R.drawable.line_img_1, "석계"));
            add(new LineCardItem(R.drawable.line_img_1, "태릉입구"));
            add(new LineCardItem(R.drawable.line_img_1, "화랑대"));
            add(new LineCardItem(R.drawable.line_img_1, "봉화산"));
        }
    };

    public static List<LineCardItem> line7 = new ArrayList<LineCardItem>() {
        {
            add(new LineCardItem(R.drawable.line_img_1, "장암"));
            add(new LineCardItem(R.drawable.line_img_1, "도봉산"));
            add(new LineCardItem(R.drawable.line_img_1, "수락산"));
            add(new LineCardItem(R.drawable.line_img_1, "마들"));
            add(new LineCardItem(R.drawable.line_img_1, "노원"));
            add(new LineCardItem(R.drawable.line_img_1, "중계"));
            add(new LineCardItem(R.drawable.line_img_1, "하계"));
            add(new LineCardItem(R.drawable.line_img_1, "공릉"));
            add(new LineCardItem(R.drawable.line_img_1, "태릉입구"));
            add(new LineCardItem(R.drawable.line_img_1, "먹골"));
            add(new LineCardItem(R.drawable.line_img_1, "중화"));
            add(new LineCardItem(R.drawable.line_img_1, "상봉"));
            add(new LineCardItem(R.drawable.line_img_1, "면목"));
            add(new LineCardItem(R.drawable.line_img_1, "사가정"));
            add(new LineCardItem(R.drawable.line_img_1, "용마산"));
            add(new LineCardItem(R.drawable.line_img_1, "중곡"));
            add(new LineCardItem(R.drawable.line_img_1, "군자"));
            add(new LineCardItem(R.drawable.line_img_1, "어린이대공원"));
            add(new LineCardItem(R.drawable.line_img_1, "건대입구"));
            add(new LineCardItem(R.drawable.line_img_1, "뚝섬유원지"));
            add(new LineCardItem(R.drawable.line_img_1, "청담"));
            add(new LineCardItem(R.drawable.line_img_1, "강남구청"));
            add(new LineCardItem(R.drawable.line_img_1, "학동"));
            add(new LineCardItem(R.drawable.line_img_1, "논현"));
            add(new LineCardItem(R.drawable.line_img_1, "반포"));
            add(new LineCardItem(R.drawable.line_img_1, "고속터미널"));
            add(new LineCardItem(R.drawable.line_img_1, "내방"));
            add(new LineCardItem(R.drawable.line_img_1, "총신대입구(이수)"));
            add(new LineCardItem(R.drawable.line_img_1, "남성"));
            add(new LineCardItem(R.drawable.line_img_1, "숭실대입구"));
            add(new LineCardItem(R.drawable.line_img_1, "상도"));
            add(new LineCardItem(R.drawable.line_img_1, "장승배기"));
            add(new LineCardItem(R.drawable.line_img_1, "신대방삼거리"));
            add(new LineCardItem(R.drawable.line_img_1, "보라매"));
            add(new LineCardItem(R.drawable.line_img_1, "신풍"));
            add(new LineCardItem(R.drawable.line_img_1, "대림"));
            add(new LineCardItem(R.drawable.line_img_1, "남구로"));
            add(new LineCardItem(R.drawable.line_img_1, "가산디지털단지"));
            add(new LineCardItem(R.drawable.line_img_1, "철산"));
            add(new LineCardItem(R.drawable.line_img_1, "광명사거리"));
            add(new LineCardItem(R.drawable.line_img_1, "천왕"));
            add(new LineCardItem(R.drawable.line_img_1, "온수"));
            add(new LineCardItem(R.drawable.line_img_1, "까치울"));
            add(new LineCardItem(R.drawable.line_img_1, "부천종합운동장"));
            add(new LineCardItem(R.drawable.line_img_1, "춘의"));
            add(new LineCardItem(R.drawable.line_img_1, "신중동"));
            add(new LineCardItem(R.drawable.line_img_1, "부천시청"));
            add(new LineCardItem(R.drawable.line_img_1, "상동"));
            add(new LineCardItem(R.drawable.line_img_1, "삼산체육관"));
            add(new LineCardItem(R.drawable.line_img_1, "굴포천"));
            add(new LineCardItem(R.drawable.line_img_1, "부평구청"));
        }
    };

    public static List<LineCardItem> line8 = new ArrayList<LineCardItem>() {
        {
            add(new LineCardItem(R.drawable.line_img_1, "암사"));
            add(new LineCardItem(R.drawable.line_img_1, "천호"));
            add(new LineCardItem(R.drawable.line_img_1, "강동구청"));
            add(new LineCardItem(R.drawable.line_img_1, "뭉촌토성"));
            add(new LineCardItem(R.drawable.line_img_1, "잠실"));
            add(new LineCardItem(R.drawable.line_img_1, "석촌"));
            add(new LineCardItem(R.drawable.line_img_1, "송파"));
            add(new LineCardItem(R.drawable.line_img_1, "가락시장"));
            add(new LineCardItem(R.drawable.line_img_1, "문정"));
            add(new LineCardItem(R.drawable.line_img_1, "장지"));
            add(new LineCardItem(R.drawable.line_img_1, "복정"));
            add(new LineCardItem(R.drawable.line_img_1, "산성"));
            add(new LineCardItem(R.drawable.line_img_1, "남한산성입구"));
            add(new LineCardItem(R.drawable.line_img_1, "단대오거리"));
            add(new LineCardItem(R.drawable.line_img_1, "신흥"));
            add(new LineCardItem(R.drawable.line_img_1, "수진"));
            add(new LineCardItem(R.drawable.line_img_1, "모란"));
        }
    };
